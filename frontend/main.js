...
const TRANSLATIONS = {
  en: {
    ...
    hero_subtitle: "Download TikTok, Instagram, YouTube & X Videos Fast",
    hero_description: "The fastest free tool to download social media videos without watermark. High quality MP4 support.",
  ...
  ko: {
    ...
    hero_subtitle: "틱톡, 인스타, 유튜브, X 영상 초고속 다운로드",
    hero_description: "워터마크 없는 소셜 미디어 영상을 즉시 다운로드하는 가장 빠른 무료 도구입니다.",
  ...
  ja: {
    ...
    meta_description: "TikTok、Instagram、YouTube、X(Twitter)の動画を即座にダウンロード。ウォーターマークなし、完全無料の最強ツール.",
    hero_title: "⚡ TAEO 動画保存・ダウンロード",
    hero_subtitle: "TikTok, Insta, YouTube, X 動画を最速保存",
    hero_description: "TikTok、Instagram、YouTube、Xの動画をウォーターマークなしで保存する最強の無料ツールです。",
    ...
    save_log: "保存場所の選択ウィンドウが表示されるまで, 最大20秒ほどかかる場合があります. 表示されるまで 그대로 기다려 주십시오.",
    complete_dialog: "完了! 保存ウィンドウを開いています...",
    howto_title: "動画の保存方法",
    howto_step1: "1. TikTok、Instagram、YouTubeから動画のリンクをコピーします。",
    howto_step2: "2. TAEOの入力欄にコピーしたリンクを貼り付けます。",
    howto_step3: "3. 「ダウンロード」ボタンを押して高画질 動画를 保存합니다.",
